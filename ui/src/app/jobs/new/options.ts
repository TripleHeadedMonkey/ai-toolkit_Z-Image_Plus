...
export const modelArchs: ModelArch[] = [
  ...
  {
    name: 'zimage:turbo:i2l_boost',
    label: 'Train Z-Image Turbo with Adapter + I2L Boost',
    group: 'image',
    defaults: {
      'config.process[0].model.name_or_path': ['Tongyi-MAI/Z-Image-Turbo', defaultNameOrPath],
      'config.process[0].model.quantize': [true, false],
      ...
      'config.process[0].train.zimage_bootstrap_enabled': [true, false],
      'config.process[0].train.zimage_i2l_model_name_or_path': ['DiffSynth-Studio/Z-Image-i2L', undefined],
      'config.process[0].train.zimage_i2l_dataset_path': ['', undefined],
      'config.process[0].train.zimage_i2l_max_images': [6, undefined],
      'config.process[0].train.zimage_i2l_device': ['cpu', undefined],
      'config.process[0].train.zimage_i2l_offload_mode': ['disk', undefined],
      'config.process[0].train.zimage_i2l_vram_limit_gb': [12, undefined],
      'config.process[0].train.zimage_bootstrap_steps': [300, undefined],
      'config.process[0].train.zimage_bootstrap_decay': ['linear', undefined],
      'config.process[0].train.zimage_bootstrap_loss_weight': [1.0, undefined],
      'config.process[0].train.zimage_init_lora_scale': [1.0, undefined],
      'config.process[0].sample.guidance_scale': [1, 4],
      'config.process[0].sample.sample_steps': [8, 25],
    },
    disableSections: ['network.conv'],
  ...
  {
    name: 'zimage:deturbo:i2l_boost',
    label: 'Train Z-Image Turbo Dedistill + I2L Boost',
    group: 'image',
    defaults: {
      'config.process[0].model.name_or_path': ['ostris/Z-Image-De-Turbo', defaultNameOrPath],
      'config.process[0].model.extras_name_or_path': ['Tongyi-MAI/Z-Image-Turbo', undefined],
  ...
  {
    name: 'zimage:turbo:i2l_only',
    label: 'Z-Image Turbo I2L',
    group: 'image',
    defaults: {
      'config.process[0].model.name_or_path': ['Tongyi-MAI/Z-Image-Turbo', defaultNameOrPath],
      'config.process[0].model.quantize': [true, false],
      ...
      'config.process[0].model.qtype': ['qfloat8', 'qfloat8'],
      'config.process[0].train.zimage_bootstrap_enabled': [true, false],
      'config.process[0].train.zimage_i2l_only': [true, false],
      'config.process[0].train.zimage_i2l_model_name_or_path': ['DiffSynth-Studio/Z-Image-i2L', undefined],
      'config.process[0].train.zimage_i2l_max_images': [6, undefined],
      'config.process[0].train.zimage_i2l_device': ['cpu', undefined],
      'config.process[0].train.zimage_i2l_offload_mode': ['disk', undefined],
      'config.process[0].train.zimage_i2l_vram_limit_gb': [12, undefined],
      'config.process[0].train.zimage_bootstrap_steps': [1000, undefined],
      'config.process[0].train.zimage_bootstrap_decay': ['linear', undefined],
      'config.process[0].train.zimage_bootstrap_loss_weight': [1.0, undefined],
      'config.process[0].train.zimage_init_lora_scale': [1.0, undefined],
      'config.process[0].sample.guidance_scale': [1, 4],
